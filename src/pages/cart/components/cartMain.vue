...
onShow(() => {
  ...
  console.log(page)
  if (page.route === 'pages/cart/cart2') {
    safeAreaInsets.value = uni.getSystemInfoSync().safeAreaInsets!.bottom
  }
})
</script>
...
<template>
  <scroll-view scroll-y class="scroll-view" @scrolltolower="onScrolltolower">
    ...
    <template v-if="memberStore.profile">
      ...
      <!-- 吸底工具栏 -->
      <view class="toolbar" :style="{ paddingBottom: safeAreaInsets + 'px' }">
        <text class="all" :class="{ checked: isSelected }" @tap="onChangeSelectedAll">全选</text>
    ...
    <!-- 猜你喜欢 -->
    <view :style="{ paddingBottom: safeAreaInsets + 'px' }">
